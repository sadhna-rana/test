      ...
      <div className={s.textcenter}>
        ...
        >
          ...
          <div className={s.formContainer}>
            <form method="POST" name="SendCvNotification" encType="multipart/form-data" data-netlify="true" data-netlify-honeypot="hiddenField" action="" onSubmit={this.handleSubmit} ref={(form) => { this.form = form; }}>
              ...
              <label htmlFor="cvfile" className={s.fileContainer}>
                 Upload your CV
                <input type="file" onChange={this.handleChange} defaultValue={this.state.file} required name="cvfile" className="upload-file" accept=".doc, .docx, .pdf" />
              </label>
