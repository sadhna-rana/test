...
import { title, showcvButton, subtitle, ourPosition, ourPositionText, ourPositionLastText, workingAtUcreateTitle, workingAtUcreateText } from './career.md';
    ...
    return (
      <div>
        ...
        <main>
          ...
          <TextSection checkPosition="positionlist" title={ourPosition} text={ourPositionText} positionText={ourPositionLastText} showCvText={showcvButton} positionID={this.state.positionID} />
